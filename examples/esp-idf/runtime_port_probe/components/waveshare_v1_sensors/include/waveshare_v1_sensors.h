...
#define WAVESHARE_V1_MOTION_MIN_PERIOD_MS 20U
#define WAVESHARE_V1_MOTION_MAX_PERIOD_MS 1000U
...
/** Changes the bounded QMI cache polling cadence used by the sole board observation. */
